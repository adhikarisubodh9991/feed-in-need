...
const DonationCertificate = ({ donation, user, certificate, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4 overflow-y-auto">
      <div className="bg-white rounded-2xl max-w-lg w-full overflow-hidden animate-fadeIn my-8">
        ...
        <div className="p-6 border-t">
          ...
          {certificate?.certificateId && (
            <button
              ...
              className="w-full py-2 mb-2 text-primary-600 hover:text-primary-700 font-medium flex items-center justify-center gap-2 border border-primary-200 rounded-lg hover:bg-primary-50 transition-colors"
            >
              <FiShare2 />
